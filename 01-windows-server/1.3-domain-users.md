...
![Client Login](../screenshots/01-windows-server-ss/client-login.png)

*Prompted to change password*

![Client Login Pt 2](../screenshots/01-windows-server-ss/client-login-pt2.png)

*Successful password change and login*

![Client Login Pt 3](../screenshots/01-windows-server-ss/client-login-pt3.png)

*Verifying Ally's domain user identity and that she has been allocated to her appropriate security group*

![Client Configuration Verification](../screenshots/01-windows-server-ss/client-login-verif.png)
