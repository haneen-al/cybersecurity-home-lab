...
A virtual USB storage device was created to provide a controlled and disposable test medium for the [REMOVABLE-STORAGE-RESTRICTION GPO](https://github.com/haneen-al/cybersecurity-home-lab/blob/main/01-windows-server/1.4-gpos.md#gpo-1---removable-storage-restriction-policy).
...
If you came from the GPO section, [Click Here To Go Back](https://github.com/haneen-al/cybersecurity-home-lab/blob/main/01-windows-server/1.4-gpos.md#gpo-1---removable-storage-restriction-policy).
